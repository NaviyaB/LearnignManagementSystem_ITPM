...
$(function(){
  ...
  <div id="txtHint"><b>Show Details about the Article...</b></div><br><br>

    <FORM name="form1" method="post" action="ArticleUpdate.php" enctype="multipart/form-data">
    <div class="container">
  ...
  <input type="text" class="form-control" id="softwares" name="AID" required ><br>
  
  <label>Article</label><br>
  <textarea rows="4" cols="50" name="article" required></textarea>
...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","AJAXArticle.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
