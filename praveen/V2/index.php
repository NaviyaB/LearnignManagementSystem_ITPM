...
<meta name="keywords" content="wwwwwwwwww" />
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> I T P M</a></h1>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="9FqQrf9aAGU" id="video"> <img src="images/SLIIT-malabe.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="col-md-6 w3l_about_bottom_right one">
		<div class="abt-w3l">
			<div class="header-w3l">
				...
				<form action="registration.php" method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="text">NIC N0.  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="nic" type="text" required=""></li>
							<li class="text">User Name  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="user_name" type="text" required=""></li>
						</ul>
					</div>
					<div class="col-md-6 col-xs-6 w3l-right-mk">
						<ul>
							...
							<li class="agileits-main"><i class="fa fa-map-marker" aria-hidden="true"></i><input name="mail_address" type="text" required=""></li>
							<li class="text">Guardian Name  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="g_name" type="text" required=""></li>
							<li class="text">Password  :  </li>
							<li class="agileits-main"><i class="fa fa-map-marker" aria-hidden="true"></i><input name="password" type="text" required=""></li>
						</ul>
					</div>
					<div class="clearfix"></div>
...
We proud to be listed as a leading and formidable awarding institute authorised and approved by the University Grants Commission (UGC) under the Universities Act, and the International Association of Universities (IAU). Furthermore, not only are we the first Sri Lankan institute to be accredited by the Institute of Engineering & Technology(IET.), UK, our IT degrees are also in turn accredited by the Engineering Council, UK. </p>
			</div> 
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">SUCCESS STORIES</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">STUDENTS GRADUATED</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
			...
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">CERTIFIED LECTURERS</h4>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>As a premier tertiary educational institute in Sri Lanka, research is a fundamental part of ITPM. Our aim is to consistently foster an environment that promotes a vibrant research culture. </p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Student Services</h5>
				<p>Student Services Help Desk, Student Forum, Career Guidance Unit, Student Counselling And Guidance</p>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>Library facilities at both the Malabe and Metro Campuses as well as at the regional centres, support a wide variety of subjects covered by the ITPM courses at many academic levels.</p>
			</div> 
			<div class="clearfix"> </div>
		</div>  
	</div>
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn1.jpg" class="swipebox"><img src="images/gn1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn2.jpg" class="swipebox"><img src="images/gn2.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn3.jpg" class="swipebox"><img src="images/gn3.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn4.jpg" class="swipebox"><img src="images/gn4.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn5.jpg" class="swipebox"><img src="images/gn5.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn6.jpg" class="swipebox"><img src="images/gn6.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn7.jpg" class="swipebox"><img src="images/gn7.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn8.jpg" class="swipebox"><img src="images/gn8.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
					...
					<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn9.jpg" class="swipebox"><img src="images/gn9.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn10.jpg" class="swipebox"><img src="images/gn10.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn11.jpg" class="swipebox"><img src="images/gn11.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/gn12.jpg" class="swipebox"><img src="images/gn12.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>I T P M</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/tn1.jpg" alt="">
				  <h5>Ms. Suriyawansa</h5>
				  <div class="about_opa">
					<p>Professor</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/tn2.jpg" alt="">
				  <h5>Ms. Ratnayake</h5>
				  <div class="about_opa">
					<p>Senior Lecturer</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/tn3.jpg" alt="">
				  <h5>Ms. Kothalawala</h5>
				  <div class="about_opa">
					<p>Lecturer</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/tn4.jpg" alt="">
				  <h5>Ms. Jayasundara</h5>
				  <div class="about_opa">
					<p>Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/tn5.jpg" alt="">
				  <h5>Ms. Liyanage</h5>
				  <div class="about_opa">
					<p>Senior Lecturer</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/tn6.jpg" alt="">
				  <h5>Ms. Jayasooriya</h5>
				  <div class="about_opa">
					<p>Lecturer</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p>+(94) 777 233 483 <span>+(94) 112 892 891 </span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com">info@itpm.com</a>
						<span><a href="mailto:info@example.com">admin@example2.com</a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
		...
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				...
				<ul>
					...
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="meadmin/index.php" >Administrator Login</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="../../teacherindex.php" >Teacher Login</a></li>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com">info@itpm.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+(94) 777 233 4831</li>
					<li><i class="fa fa-fax" aria-hidden="true"></i>+(94) 112 892 891</li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© 2019 I T P M. All rights reserved | Design by Praveen Keith</a></p>
	</div>
</div>
<!-- //footer -->
...
<!-- Map-JavaScript -->
			 <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDV93Vhvfh0zyJvovi5zB5gyjepegjmAX4"></script>        
			<script type="text/javascript">
				google.maps.event.addDomListener(window, 'load', init);
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(6.9148346,79.970947),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(6.9148346,79.970947),
						map: map,
					});
				}
			</script> -->
			<!-- <script src='https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDV93Vhvfh0zyJvovi5zB5gyjepegjmAX4'></script>
			<div style='overflow:hidden;height:400px;width:520px;'>
				...
				<a href='https://www.embedmap.net/'>embed google map on website</a>
				<script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=d5aebea90ee5e9757c1c79cb9fe1385ec4c9d570'>
				</script>
				<script type='text/javascript'>function init_map(){var myOptions = {zoom:12,center:new google.maps.LatLng(6.9148346,79.970947),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(7,81)});infowindow = new google.maps.InfoWindow({content:'<strong>SLIIT</strong><br>I T P M<br> Malabe<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script> -->
