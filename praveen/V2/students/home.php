	...
	<div class="page-container">
		...
		<div class="left-content">
								...
								<div class="graph">
									<nav>
										<ul>
											...
											<li><a href="#section-6" class="article"> <span>Article</span></a></li>
										</ul>
									</nav>
            ...
            <br> 
						...
						<div class="chrt-inner">
							...
							<div class="graph-visualization">
								...
								<section id="section-6">
											...
											<li><a href="../../../InsertArticle.php" > <span>Inser Article</span></a></li><br><br><br><br>
											<li><a href="../../../UpdateArticle.php" > <span>Update Article</span></a></li><br><br><br><br>
											<li><a href="../../../DeleteArticle.php" > <span>Removen Article</span></a></li><br><br><br><br>
				...
				<footer>
					<p>© 2019 I T P M. All rights reserved | Design by Praveen Keith</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>I T P M</h1></span> 
			...
			<!--/down-->
			<div class="down">
				<a href="index.html"><img src="images/adminn.jpg"></a>
